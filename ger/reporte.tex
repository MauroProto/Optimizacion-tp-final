...
La busqueda bayesiana usa Optuna/TPE con 100 trials y 800 iteraciones por trial.
...
\bottomrule
\end{tabular}
\caption{Comparacion principal con arquitectura $[2,80,80,80,1]$ y 3000 iteraciones.}
\end{table}
...
cada trial de Optuna es un punto de la trayectoria y el plano usado es
$\log_{10}(\eta)$ contra $\beta$ adaptativo.
